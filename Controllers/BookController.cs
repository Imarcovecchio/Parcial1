...
namespace Parcialherramientas.Controllers
{
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Editorial,Año,Genero")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Editorial,Año,Genero")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
